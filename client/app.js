...
var getValues = function(){
  var name = document.querySelector('input[name=symbol-name]').value;
...
var stockTemplate = 
  '<button class="list-group-item"><h3>'+
    '<%= name %> '+
    '<span class="badge xl"> <%= value %></span>'+
  '</h3></button>';

var stocks = [
    {id: 1, name:'epam' , value: 79},
    {id: 2, name:'yahoo' , value: 80},
    {id: 3, name:'google' , value: 81},
    {id: 4, name:'facebook' , value: 82},
    {id: 5, name:'walmart' , value: 83}
  ];

var makeStockTemplate = function(data) {
  ...
  stockList.insertBefore(stockList.lastChild);
}
...
function showList(stocks) {
  ...
  stocks.forEach(function(stock){
    $('#stock-list').append('<button class="list-group-item"><h3>'+stock.name+' <span class="badge xl">'+stock.value+'</span></h3></button>');
  });
}
